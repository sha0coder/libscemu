...
pub fn gateway(addr:u32, emu:&mut emu::Emu) -> String {
    match addr {
        ...
        _ => {  
            ...
            println!("calling unimplemented oleaut32 API 0x{:x} {}", addr, apiname);
            return apiname;
        }
    }
...
fn SysAllocStringLen(emu:&mut emu::Emu) {
    ...
    let mut size = emu.maps.read_dword(emu.regs.get_esp()+4)
    ...
    println!("{}** {} oleaut32!SysAllocStringLen  ={} {} {}", emu.colors.light_red, emu.pos, name, 
        size-8, emu.colors.nc);
...
fn SysFreeString(emu:&mut emu::Emu) {
    ...
    println!("{}** {} oleaut32!SysFreeString  0x{:x} {}", emu.colors.light_red, emu.pos, str_ptr, emu.colors.nc);
